...
gfx read node $fitpath.'/Torso_fitted_TEST_ROTATE' reg mesh_TorsoFitted_TEST_ROTATE;
gfx read elem $fitpath.'/Torso_fitted' reg mesh_TorsoFitted_TEST_ROTATE;
gfx read data $datapath.'/surface_Torsotrimmed_prepared';
...
gfx mod g_e mesh_TorsoFitted_TEST_ROTATE surface mat tissue;
gfx mod g_e mesh_TorsoFitted_TEST_ROTATE node_points glyph sphere general size "4*4*4" material red;

#gfx mod g_e surface_Torso data_points glyph point size "4*4*4" material green;
gfx mod g_e surface_Torso data_points glyph point size "4*4*4" material gold;
