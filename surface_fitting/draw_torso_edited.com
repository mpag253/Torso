...
gfx read node $fitpath.'/Torso_edited' reg mesh_TorsoEdited;
gfx read elem $fitpath.'/Torso_fitted' reg mesh_TorsoEdited;
...
gfx mod g_e mesh_TorsoEdited surface mat tissue;
gfx mod g_e mesh_TorsoEdited node_points glyph sphere general size "4*4*4" material blue;
